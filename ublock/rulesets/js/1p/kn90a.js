...
const argsMap = new Map([[48752711,{"a":[{"selector":"div[class]:not([id])","tasks":[["has",{"selector":" > .ad-text"}]]}]}],[281019536,{"a":[{"selector":"div[class^=\"slot-\"]","tasks":[["has",{"selector":" > div[class^=\"slot\"][class$=\"plug\"]"}]]}]}],[976929646,{"a":[{"selector":".adsbox.ad","action":["style","display: block!important;"],"cssable":true}]}]]);

const hostnamesMap = new Map([["chelmski.eu",48752711],["poczta.onet.pl",281019536],["se.pl",976929646]]);
