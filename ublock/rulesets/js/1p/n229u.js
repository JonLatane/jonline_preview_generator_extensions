...
const argsMap = new Map([[1846462262,{"a":[{"selector":"[id^=\"bdaia-widget-html\"]","tasks":[["has",{"selector":".widget-inner > [href*=\"premiumvns.com\"]"}]]}]}],[1323102538,{"a":[{"selector":".ladi-section","tasks":[["has",{"selector":"a[href^=\"https://www.youtube.com/watch\"]"}]]}]}]]);

const hostnamesMap = new Map([["linkerpt.com",1846462262],["o-study.net",1323102538]]);
