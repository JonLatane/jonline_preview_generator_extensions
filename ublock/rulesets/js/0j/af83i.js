...
const argsMap = new Map([[525789662,{"a":[{"selector":"#sp-component","action":["style","width: 100% !important;"],"cssable":true}]}],[1276048416,{"a":[{"selector":"#hp-readmore-cross-article .article","tasks":[["has",{"selector":".byline_date","tasks":[["has-text","ADVERTORIAL"]]}]]}]}]]);

const hostnamesMap = new Map([["serraikanea.gr",525789662],["sport24.gr",1276048416]]);
