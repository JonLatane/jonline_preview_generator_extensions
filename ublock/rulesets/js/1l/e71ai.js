...
const argsMap = new Map([[590274313,{"a":[{"selector":".td_block_template_1 > a","tasks":[["has-text",""]]},{"selector":".td_block_template_1 > center > a","tasks":[["has-text",""]]}]}],[2079315947,{"a":[{"selector":".td_block_template_1","tasks":[["has-text","- Advertisement -"]]}]}],[1248493907,{"a":[{"selector":".a-listing > li","tasks":[["has",{"selector":".adsbygoogle"}]]}]}]]);

const hostnamesMap = new Map([["lajmifundit.al",590274313],["mediaworld.al",2079315947],["tej.al",1248493907]]);
