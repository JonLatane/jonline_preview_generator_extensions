...
const argsMap = new Map([[735080687,{"a":[{"selector":".boost-list-container > [style] > [class]","tasks":[["has",{"selector":" > a[href^=\"https://aa.boostapi.net\"]"}]]}]}],[1126279880,{"a":[{"selector":".vc_raw_html","tasks":[["has-text","Html code"]]}]}],[2066761905,{"a":[{"selector":"#content > div > a","tasks":[["has-text",""]]}]}]]);

const hostnamesMap = new Map([["joq-albania.com",735080687],["joqalbania.com",735080687],["kohajone.com",1126279880],["gazetatema.net",2066761905]]);
