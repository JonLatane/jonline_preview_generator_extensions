...
const argsMap = new Map([[666746332,{"a":["*","list.*.link.ad list.*.link.kicker"]}],[254442093,{"a":["ad"],"n":["work.weixin.qq.com"]}]]);

const hostnamesMap = new Map([["msn.cn",666746332],["qq.com",254442093]]);
