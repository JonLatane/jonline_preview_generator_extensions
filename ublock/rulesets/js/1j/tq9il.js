...
const argsMap = new Map([[1027478943,{"a":["dfpConfig","loadAds"]}],[1688086417,{"a":["adblockDetector"]}],[230575961,{"a":["EventTarget.prototype.addEventListener","window.TextDecoder"]}]]);

const hostnamesMap = new Map([["gamer.no",1027478943],["tu.no",1027478943],["tv2.no",1688086417],["bold.dk",230575961]]);
