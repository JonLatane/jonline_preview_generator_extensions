...
const argsMap = new Map([[539814510,{"a":[{"selector":"div.box","tasks":[["has-text",["^reklama","i"]]]}]}],[957756175,{"a":[{"selector":"a","tasks":[["matches-css",{"name":"background-image","value":"url"}],["matches-css",{"name":"position","value":"^fixed$"}],["upward",1]]}]}],[1288010117,{"a":[{"selector":".top_bg_content","action":["style","top: 0px !important;"],"cssable":true}]}],[1707406220,{"a":[{"selector":"div.article--content","tasks":[["has",{"selector":"div.design-advert"}]]}]}]]);

const hostnamesMap = new Map([["dotekomanie.cz",539814510],["indian-tv.cz",957756175],["nerdfix.cz",957756175],["kupi.cz",1288010117],["lupa.cz",1707406220],["root.cz",1707406220]]);
