...
const argsMap = new Map([[1766522571,{"a":[{"selector":".main_table_center_content","tasks":[["has",{"selector":"div","tasks":[["has-text","Promociones especiales"]]}]]}]}],[774943981,{"a":[{"selector":"div","tasks":[["has",{"selector":" > h3","tasks":[["has-text","CHAT PORNO X"]]}]]}]}],[232849290,{"a":[{"selector":"em","tasks":[["has-text","Patrocinado:"]]},{"selector":"strong","tasks":[["has-text","Reclama tu crédito"]]}]}],[1551172688,{"a":[{"selector":"#sidebar > .adpv","tasks":[["has-text","Camiseta de la semana"]]},{"selector":".adpv","tasks":[["has",{"selector":" > .adsbygoogle"}]]},{"selector":".posts","tasks":[["has",{"selector":" > div > div > .adsbygoogle"}]]}]}]]);

const hostnamesMap = new Map([["mejortorrentes.net",1766522571],["videospornogratisx.net",774943981],["lecter.news",232849290],["finofilipino.org",1551172688]]);
