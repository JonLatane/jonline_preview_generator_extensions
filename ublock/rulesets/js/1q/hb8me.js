...
const argsMap = new Map([[786666528,{"a":[{"selector":".partner-item","tasks":[["upward",".bg-gray-100"]]}]}],[2095096048,{"a":[{"selector":".LStatic__inner","action":["style","padding-top: 0 !important"],"cssable":true}]}],[1799615683,{"a":[{"selector":".fl-row","tasks":[["has",{"selector":"iframe[src*=\"undefined\"]"}]]}]}],[1251353263,{"a":[{"selector":".widget_text","tasks":[["has",{"selector":"a:not([href*=\"suvalkai.\"])"}]]}]}]]);

const hostnamesMap = new Map([["lkl.lt",786666528],["lrytas.lt",2095096048],["lzinios.lt",1799615683],["suvalkai.lt",1251353263]]);
