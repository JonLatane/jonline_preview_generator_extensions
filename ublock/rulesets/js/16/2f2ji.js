...
const argsMap = new Map([[1475180422,{"a":[{"selector":".td-block-title-wrap > h4 > span","tasks":[["has-text","REKLAMA"]]}]}],[1899804319,{"a":[{"selector":".modal-open","action":["style","overflow: visible"],"cssable":true}]}]]);

const hostnamesMap = new Map([["shkoder.net",1475180422],["bankofalbania.org",1899804319]]);
