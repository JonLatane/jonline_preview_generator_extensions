...
const argsMap = new Map([[1707223842,{"a":[{"selector":"div","tasks":[["has",{"selector":" > a[href*=\"?act=detail&f=8\"]"}]]}]}],[1560610175,{"a":[{"selector":"h3","tasks":[["has-text","^Reklama$"]]}]}],[1521639577,{"a":[{"selector":"div.dragging-enabled","tasks":[["has",{"selector":"div.gadget--reklama"}]]}]}],[1695107199,{"a":[{"selector":"body","action":["style","background:none !important;"],"cssable":true}]}]]);

const hostnamesMap = new Map([["motorkari.cz",1707223842],["parabola.cz",1560610175],["www.seznam.cz",1521639577],["uschovna.cz",1695107199]]);
