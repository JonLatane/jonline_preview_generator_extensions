...
const argsMap = new Map([[256754291,{"a":[{"selector":".hsdn > li","tasks":[["has",{"selector":".adsbygoogle"}]]}]}],[1736205432,{"a":[{"selector":".block","tasks":[["has",{"selector":".block-container > .block-body > a[href]"}]]},{"selector":".block","tasks":[["has",{"selector":".block-container > .block-body > ins"}]]}]}]]);

const hostnamesMap = new Map([["hosocongty.vn",256754291],["techrum.vn",1736205432]]);
