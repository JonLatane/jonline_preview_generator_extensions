...
const argsMap = new Map([[811941657,{"a":[{"selector":"html","action":["style","overflow: auto!important"],"cssable":true}]}],[823927804,{"a":[{"selector":".col","tasks":[["has",{"selector":"span","tasks":[["has-text","Tin tài trợ"]]}]]},{"selector":"div.pos-rel","tasks":[["has",{"selector":"a[rel=\"nofollow sponsored\"]"}]]}]}]]);

const hostnamesMap = new Map([["vebotv.team",811941657],["24h.com.vn",823927804]]);
