...
const argsMap = new Map([[1392357848,{"a":[{"selector":"body","action":["style","background-image: none !important;"],"cssable":true}]}],[163854159,{"a":[{"selector":"#LRGR","action":["style","background: none !important;"],"cssable":true}]}]]);

const hostnamesMap = new Map([["kozanilife.gr",1392357848],["lamiareport.gr",163854159]]);
