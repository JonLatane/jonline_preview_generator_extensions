...
const argsMap = new Map([[859488407,{"a":[{"selector":".tien-ads-video > div#player","action":["style","visibility: visible!important;"],"cssable":true},{"selector":".tien-ads-video","action":["style","background: none!important;"],"cssable":true}]}]]);

const hostnamesMap = new Map([["koozi.info",859488407]]);
