...
const argsMap = new Map([[895584984,{"a":[{"selector":"#__next > div[class^=\"bm_\"]","tasks":[["has",{"selector":"#BaoMoi_Masthead"}]]}]}],[2094333099,{"a":[{"selector":"#header","action":["style","margin-top: 0 !important"],"cssable":true}]}]]);

const hostnamesMap = new Map([["baomoi.com",895584984],["chotlo.com",2094333099]]);
