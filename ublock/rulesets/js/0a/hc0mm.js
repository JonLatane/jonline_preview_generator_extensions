...
const argsMap = new Map([[810447359,{"a":[{"selector":".main > #header","action":["style","margin-top: unset !important"],"cssable":true},{"selector":".main > .fixed_userbar","action":["style","margin-bottom: unset !important"],"cssable":true}]}],[535491645,{"a":[{"selector":".col-18.no-padding.vl-auto-row","tasks":[["has",{"selector":"iframe"}]]},{"selector":".item","tasks":[["has",{"selector":" > a[href*=\"//bit.ly\"][target=\"_blank\"] > img"}]]},{"selector":"script + div:not(.header)","tasks":[["has",{"selector":" + .wrapper"}]]}]}],[21149916,{"a":[{"selector":".bdaia-widget","tasks":[["has",{"selector":"a[href*=\"undefined\"]"}]]},{"selector":"div[data-vc-full-width]","tasks":[["has",{"selector":"div[id^=\"undefined\"]"}]]}]}],[1123680417,{"a":[{"selector":".obj-cont dt","tasks":[["has-text"," Reklama/"]]}]}]]);

const hostnamesMap = new Map([["torrent.ai",810447359],["torrent.lt",810447359],["15min.lt",535491645],["aina.lt",21149916],["aruodas.lt",1123680417]]);
