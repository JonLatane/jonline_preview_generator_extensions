...
const argsMap = new Map([[941292813,{"a":[{"selector":".widget","tasks":[["has",{"selector":".lazyloaded"}]]}]}],[1409837390,{"a":[{"selector":".location-choose.open > wrapper","action":["style","visibility:hidden;"],"cssable":true}]}],[293129719,{"a":[{"selector":".widget","tasks":[["has-text","REKLAMA"]]}]}]]);

const hostnamesMap = new Map([["360grade.al",941292813],["cineplexx.al",1409837390],["konica.al",293129719]]);
